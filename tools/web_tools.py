...
def _get_firecrawl_client():
    ...
    Managed Firecrawl cloud only (requires FIRECRAWL_API_KEY). The
    self-hosted path behind FIRECRAWL_API_URL was removed — see
    docs/proposals/self_hosted_firecrawl.md for the parked design.
    """
