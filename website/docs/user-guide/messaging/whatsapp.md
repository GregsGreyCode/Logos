...
The Baileys bridge saves its session under `~/.logos/whatsapp/session`. This means:
...
- The `~/.logos/whatsapp/session` directory contains full session credentials — protect it like a password
- Set file permissions: `chmod 700 ~/.logos/whatsapp/session`
