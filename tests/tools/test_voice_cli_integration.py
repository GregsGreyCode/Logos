...
class TestCtrlCResetsContinuousMode:
    ...
    def test_ctrl_c_handler_resets_voice_continuous(self):
        ...
        with open("hermes_cli/cli.py") as f:
            source = f.read()
...
class TestVoiceSpeakResponseReal:
    ...
    @patch("hermes_cli.cli._cprint")
    @patch("hermes_cli.cli.os.unlink")
    @patch("hermes_cli.cli.os.path.getsize", return_value=1000)
    @patch("hermes_cli.cli.os.path.isfile", return_value=True)
    @patch("hermes_cli.cli.os.makedirs")
