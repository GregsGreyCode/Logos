...
def setup_model_provider(config: dict):
    ...
    if provider_idx == 0:  # Nous Portal (OAuth)
        ...
        try:
            from logos_cli.auth import _login_nous, ProviderConfig
            import argparse
        ...
        try:
            from logos_cli.auth import deactivate_provider
        ...
        if api_key:
            ...
            from logos_cli.auth import detect_zai_endpoint
        ...
        from logos_cli.auth import PROVIDER_REGISTRY
        from logos_cli.config import save_anthropic_api_key, save_anthropic_oauth_token
    ...
    if selected_provider != "custom":  # Custom already prompted for model name
        ...
        if selected_provider == "nous" and nous_models:
            ...
            from logos_cli.models import provider_model_ids
            ...
            from logos_cli.models import model_ids, menu_labels
