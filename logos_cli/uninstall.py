...
- Keep data: Remove code but keep ~/.logos/ (configs, sessions, logs)
"""
...
def remove_wrapper_script():
    ...
    for wrapper in wrapper_paths:
        if wrapper.exists():
            try:
                # Check if it's our wrapper (contains logos_cli reference)
                content = wrapper.read_text()
                if 'logos_cli' in content or 'hermes-agent' in content:
                    wrapper.unlink()
...
def run_uninstall(args):
    ...
    print(color("│               ⚕ Logos Uninstaller                      │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    if not full_uninstall:
        ...
        print(color("  git clone https://github.com/GregsGreyCode/Logos.git && cd Logos && pip install -e .", Colors.DIM))
        print()
    
    print(color("Reload your shell to complete the process:", Colors.YELLOW))
    print("  source ~/.bashrc  # or ~/.zshrc")
    print()
    print("Thank you for using Logos! ⚕")
    print()
