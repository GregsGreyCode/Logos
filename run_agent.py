...
class AIAgent:
    ...
    def run_conversation(
        ...
        # has passed.  Called at run_conversation() start so it fires on first
        # use in both CLI and gateway contexts without a separate cron job.
        # cleanup_expired_once_at_startup() is idempotent — a no-op after the
