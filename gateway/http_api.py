...
<body>
  <div x-data="loginApp()" x-init="init()" class="relative z-10 w-full px-5" style="max-width:400px;">
    ...
    <div class="text-center mb-9 fade-up">
      ...
      <p style="font-size:0.8rem;color:rgba(100,116,139,0.9);letter-spacing:0.04em;">AI agent platform</p>
    </div>
        ...
        <div x-data="{ show: false }">
          ...
          <div class="relative">
            ...
            <button type="button" @click="show=!show" tabindex="-1"
                    ...
                    onmouseout="this.style.color='rgba(100,116,139,0.7)'">
