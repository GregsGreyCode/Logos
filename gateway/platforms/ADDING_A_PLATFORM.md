...
## 12. Status Display (`logos_cli/status.py`)
...
## 13. Gateway Setup Wizard (`logos_cli/gateway.py`)
...
grep -r "telegram\|discord\|whatsapp\|slack" gateway/ tools/ agent/ cron/ logos_cli/ toolsets.py \
  --include="*.py" -l | sort -u
