...
COMMANDS_BY_CATEGORY = {
    ...
    "Info": {
        ...
        "/runs": "Show run audit log (usage: /runs [id|replay <id>|clone <id>])",
        "/metrics": "Show observability dashboard (usage: /metrics [--days N] [prometheus])",
        "/evals": "Run or list evaluation suites (usage: /evals [list|run <suite>|results])",
